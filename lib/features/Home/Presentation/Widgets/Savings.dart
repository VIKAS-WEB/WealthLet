            ...
            Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage('assets/images/CurrentBalance.jpg'),
                  fit: BoxFit.cover,
              ...
              child: Card(
                elevation:
                    0, // Elevation removed since shadow is handled by Container
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10),
                ),
                color:
                    Colors
                        .transparent, // Card ko transparent kiya taaki background image dikhe
                child: Padding(
                  padding: EdgeInsets.all(16.0),
                  child: Column(
